...
import { Mail, MapPin, User, CheckCircle, Globe } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 w-full max-w-5xl mx-auto">
        ...
        <div className="flex-1">
          <div className="bg-dark-800/80 border border-gray-600 rounded-2xl shadow-xl p-8">
            <h1 className="text-4xl font-bold text-green-400 mb-2">Hüseyin Koç</h1>
            <h2 className="text-xl text-gray-200 mb-4">Computer Engineering Student</h2>
            <div className="flex flex-wrap items-center gap-4 text-gray-300 mb-4">
              <span className="flex items-center gap-1"><Mail size={18} className="text-green-400" /> kochuseyin@hotmail.fr</span>
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-4">
              <div className="flex items-center gap-2 text-green-400">
                <CheckCircle size={20} />
                <span className="text-gray-200">Python, C#, Java, MySQL, ASP.NET MVC, PL/SQL, Oracle DB</span>
              </div>
              <div className="flex items-center gap-2 text-green-400">
                <Globe size={20} />
                <span className="text-gray-200">Turkish, French (native), English (B1-B2)</span>
              </div>
            </div>
          </div>
        </div>
